    ...
    <div class="inforUserContainer">
        <div class="inforUserSideBar p-4">
            ...
            <ul id="myAccSub" class="text-sm ml-6">
                ...
                <a href="?quanly=user/account/payment" class="cursor-pointer liAcc hover:text-teal-600"><li>Ngân hàng</li></a>
                ...
                <a href="?quanly=user/account/setting/notification" class="cursor-pointer liAcc hover:text-teal-600 active"><li>Cài đặt thông báo</li></a>
            </ul>
