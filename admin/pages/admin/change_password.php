...
<body>
    ...
    <div class="inforUserContainer">
        <div class="inforUserSideBar p-4">
            ...
            <p id="myAcc" class="myAcc cl cursor-pointer text-base mt-3">
                <a href="?action=admin/profile">
                    <i class="far fa-user"></i> Tài khoản của tôi
                </a>
            </p>
            <ul id="myAccSub" class="text-sm ml-6">
                <a href="?action=admin/profile" class="cursor-pointer liAcc hover:text-slate-500 "><li >Hồ sơ</li></a>
                ...
                <a href="?action=admin/change_password" class="cursor-pointer liAcc active"><li>Đổi mật khẩu</li></a>
